...
const { PizzaOrderRecognizer } = require('./dialogs/pizzaOrderRecognizer');
...
// If configured, pass in the PizzaOrderRecognizer.  (Defining it externally allows it to be mocked for tests)
