...
az vm extension set \
    ...
    --resource-group azuremolchapter8 \
    --vm-name webvm1 \
    --settings '{"fileUris":["https://raw.githubusercontent.com/fouldsy/azure-mol-samples-2nd-edition/master/08/install_webvm1.sh"],"commandToExecute":"sh install_webvm1.sh"}'
...
az vm extension set \
    ...
    --resource-group azuremolchapter8 \
    --vm-name webvm2 \
    --settings '{"fileUris":["https://raw.githubusercontent.com/fouldsy/azure-mol-samples-2nd-edition/master/08/install_webvm2.sh"],"commandToExecute":"sh install_webvm2.sh"}'
